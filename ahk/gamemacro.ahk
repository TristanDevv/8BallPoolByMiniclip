...
res := WaitForImage(seefreinds, &foundX, &foundY, 5000, 10)
if (res = true) {
    Sleep(50)
    ControlClick("x" foundX " y" foundY, firefox_hwnd)
}

res := WaitForImage(challange, &foundX, &foundY, 5000, 10)
if (res = true) {
    Sleep(50)
    ControlClick("x" foundX " y" foundY, firefox_hwnd)
}

res := WaitForImage(table, &foundX, &foundY, 5000, 10)
if (res = true) {
    Sleep(50)
    ControlClick("x" foundX " y" foundY, firefox_hwnd)
}
...
res := WaitForImage(playnow, &foundX, &foundY, 5000, 10)
...
resx := WaitForImage(playnow_ff, &foundX, &foundY, 5000, 10)
if (resx = true) {
    ControlClick("x" foundX " y" foundY, firefox_hwnd)
}
...
res := WaitForImage(game_menu, &foundX, &foundY, 15000, 80)
if (res = true) {
    ControlClick("x" foundX " y" foundY, midori_hwnd)
} 

res := WaitForImage(leave_menu, &foundX, &foundY, 15000, 80)
if (res = true) {
    ControlClick("x" foundX " y" foundY, midori_hwnd)
} 

res := WaitForImage(leave_button, &foundX, &foundY, 15000, 80)
if (res = true) {
    ControlClick("x" foundX " y" foundY, midori_hwnd)
}
...
res := WaitForImage(back_button, &foundX, &foundY, 15000, 80)
if (res = true) {
    ControlClick("x" foundX " y" foundY, firefox_hwnd)
}